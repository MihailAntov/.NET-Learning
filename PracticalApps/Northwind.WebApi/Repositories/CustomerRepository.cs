...
namespace Northwind.WebApi.Repositories
{
    ...
    {
        //use a static thread-safe dictionary field to cache to customers
        ...
        {
            db = injectedContext;
            //pre-Load customers from database as a normal Dictionary with
            //CustomerId as the key, then convert them to a thread-safe
